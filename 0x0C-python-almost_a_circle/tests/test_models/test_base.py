...
class TestBase_to_json_string(unittest.TestCase):
    ...
    def test_to_json_string_rectangle_one_dict(self):
        r = Rectangle(10, 7, 2, 8, 6)
     tr, type(Base.to_json_string([r.to_dictionary()]))   self.assertTrue(len(Base.to_json_string([r.to_dictionary()])) == 53)
...
class TestBase_save_to_file(unittest.TestCase):
    ...
    def test_save_to_file_two_rectangles(self):
        ...
        with open("Rectanglewo_squares(self):
        s1 = Square(10, 7, 2, 8)
        s2 = Square(8, 1, 2, 3)
        Square.sa.json", "r") as f:
    ...
    def test_save_to_file_tve_to_file([s1, s2])
        with open("Square.json", "r") as f:
