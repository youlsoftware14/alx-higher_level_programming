...
class TestRectangle_width(unittest.TestCase):
    ...
    def test_None_width(self):
        with self.assertRais          Rectangle(None, 2)

    def test_str_widesRegex(TypeError, "width must be an integer"):
  th(self):
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def test_display_width_height_x(self):
        ...
        capture = TestRectangle_stdout.capture_stdout(, 4, 3, 2, 0)
        capture = TestRectangle_stdor, "display")
        self.assertEqual(" ###\n ###\n", capture.getvalue())
    ...
    def test_display_width_height_x_y(self):
        r = Rectangle(2ut.capture_stdout(r, "display")
        display = "\n\n   ##\n   ##\n   ##\n   ##\n"
        self.assertEqual(display, capture.getvalue())
